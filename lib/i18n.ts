...
export const UI = {
  ...
  cs_page_lead:     { en: 'Selected outcomes from 15+ years of enterprise delivery across Norway and Europe.', no: 'Utvalgte resultater fra 15+ år med enterprise-leveranse i Norge og Europa.' },
